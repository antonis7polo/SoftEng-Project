...
describe('/newnames command', () => {
    ...
    it('successfully uploads a file', (done) => {
        shell.exec('se2321 newnames -f /Users/harrypapadakis/Documents/7th_semester/software_engineering/truncated_data/truncated_name.basics.tsv', { silent: true }, (code, stdout, stderr) => {
            expect(code).toBe(0);
            expect(stderr).toBe('');
    ...
    it('handles non-existent file', (done) => {
        shell.exec('se2321 newnames -f /Users/harrypapadakis/Documents/7th_semester/software_engineering/truncated_data/foo.tsv', { silent: true }, (code, stdout, stderr) => {
            expect(code).toBe(1);
    ...
    it('handles invalid format file', (done) => {
        shell.exec('se2321 newnames -f /Users/harrypapadakis/Documents/7th_semester/software_engineering/SRS.pages', { silent: true }, (code, stdout, stderr) => {
            expect(code).toBe(1);
